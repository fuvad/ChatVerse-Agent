const Header = () => {
    return (
        <header className="relative flex items-center justify-between px-8 py-5 bg-gradient-to-r from-[#075E54] to-[#128C7E] z-10">
            ...
            <div className="flex items-center relative">
                ...
                <span className="font-bold text-white text-xl tracking-tight">ChatVerse 1.0</span>
            </div>
